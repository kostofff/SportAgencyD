        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClubName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteAds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AthleteAds_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Sport = table.Column<int>(type: "int", nullable: false),
                    SearchedPosition = table.Column<int>(type: "int", nullable: false),
                    SearchedStrongFoot = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubAds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubAds_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteAds_UserId",
                table: "AthleteAds",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ClubAds_UserId",
                table: "ClubAds",
                column: "UserId");
        }
